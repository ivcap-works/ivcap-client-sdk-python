...
def _get_kwargs(
    *,
    ...
    order_desc: Union[Unset, None, bool] = True,
...
) -> Optional[Union[Any, BadRequestT, DashboardListRT, InvalidParameterT, InvalidScopesT]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, BadRequestT, DashboardListRT, InvalidParameterT, InvalidScopesT]]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        order_desc (Union[Unset, None, bool]): When set order result in descending order.
            Ascending order is the lt. Default: True. Example: True.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, BadRequestT, DashboardListRT, InvalidParameterT, InvalidScopesT]
    """
