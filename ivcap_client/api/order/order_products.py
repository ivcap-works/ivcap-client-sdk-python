...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/1/orders/{order_id}/products".format(
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | PartialProductListT | ResourceNotFoundT
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | PartialProductListT | ResourceNotFoundT]
    """
