...
) -> Optional[Union[Any, BadRequestT, InvalidParameterT, InvalidScopesT, ProjectListRT]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, BadRequestT, InvalidParameterT, InvalidScopesT, ProjectListRT]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, BadRequestT, InvalidParameterT, InvalidScopesT, ProjectListRT]
    """
