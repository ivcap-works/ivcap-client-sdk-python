...
) -> Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | QueueListResult | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | QueueListResult]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | QueueListResult
    """
