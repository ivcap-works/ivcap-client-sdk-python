...
) -> Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | ServiceListRT | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | ServiceListRT]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        order_desc (bool | Unset): When set order result in descending order. Ascending order is
            the lt. Default: True. Example: True.
...
def sync(
    *,
    ...
    Returns:
        Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | ServiceListRT
    """
