...
) -> Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | XServiceListRT | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | XServiceListRT]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | BadRequestT | InvalidParameterT | InvalidScopesT | NotImplementedT | XServiceListRT
    """
