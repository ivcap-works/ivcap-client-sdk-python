...
class ListMetaRT:
    """
    Example:
        {'aspect-path': 'Qui aliquid sit.', 'at-time': '1996-12-19T16:39:57-08:00', 'entity': 'urn:blue:image.collA.12',
    ...
    Attributes:
        ...
        aspect_path (Union[Unset, str]): Optional json path to further filter on returned list Example: Non qui est..
