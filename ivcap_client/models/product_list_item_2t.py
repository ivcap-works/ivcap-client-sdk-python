...
class ProductListItem2T:
    ...
    Attributes:
        ...
        mime_type (str | Unset):  Example: Repudiandae aut ut perferendis reprehenderit..
        name (str | Unset):  Example: Et ut nam alias..
        size (int | Unset):  Example: 787893284358373318.
    """
