...
from ..models.project_list_item_status import ProjectListItemStatus
...
class ProjectListItem:
    ...
    Example:
        {'account': 'urn:ivcap:account:146d4ac9-244a-4aee-aa32-a28f4b91e60d', 'at-time': '1996-12-19T16:39:57-08:00',
            ...
            investigate [objective]'}, 'role': 'Member', 'status': 'active', 'urn':
    ...
    Attributes:
        ...
        status (ProjectListItemStatus | Unset): Project status Example: active.
    """
    ...
    status: ProjectListItemStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: ProjectListItemStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ProjectListItemStatus(_status)
