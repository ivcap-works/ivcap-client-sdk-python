...
T = TypeVar("T", bound="ProjectModifyRequest")


@_attrs_define
class ProjectModifyRequest:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_modify_request.additional_properties = d
        return project_modify_request
