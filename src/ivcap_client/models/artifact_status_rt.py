...
class ArtifactStatusRT:
    ...
    Example:
        {'account': 'urn:ivcap:account:123e4567-e89b-12d3-a456-426614174000', 'cache-of': 'urn:ivcap:artifact:00000',
            ...
            'policy': 'urn:ivcap:policy:123e4567-e89b-12d3-a456-426614174000', 'size': 1282841386396344806, 'status':
            'partial'}
    ...
    Attributes:
        ...
        status (ArtifactStatusRTStatus): Artifact status Example: error.
        ...
        size (Union[Unset, int]): Size of data Example: 4540949357346740172.
    """
