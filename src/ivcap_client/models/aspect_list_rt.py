...
class AspectListRT:
    """
    Example:
        {'aspect-path': 'Harum impedit qui voluptatibus.', 'at-time': '1996-12-19T16:39:57-08:00', 'entity':
    ...
    Attributes:
        ...
        aspect_path (Union[Unset, str]): Optional json path to further filter on returned list Example: Rerum est et
            laudantium qui maiores..
