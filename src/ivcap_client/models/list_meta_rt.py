...
class ListMetaRT:
    """
    Example:
        {'aspect-path': 'Ut quasi minus et ad eius commodi.', 'at-time': '1996-12-19T16:39:57-08:00', 'entity':
    ...
    Attributes:
        ...
        aspect_path (Union[Unset, str]): Optional json path to further filter on returned list Example: Placeat tenetur
            qui libero et iusto et..
