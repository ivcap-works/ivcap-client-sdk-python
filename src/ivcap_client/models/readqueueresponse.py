...
class Readqueueresponse:
    """
    Example:
        {'bytes': 12288071406151857078, 'consumer-count': 1715190889629260141, 'created-at':
            '1996-12-19T16:39:57-08:00', 'description': 'Events for the event service', 'first-id':
            'http://hoppewintheiser.com/clotilde', 'first-time': '1996-12-19T16:39:57-08:00', 'id':
            'urn:ivcap:queue:123e4567-e89b-12d3-a456-426614174000', 'last-id': 'http://schillerolson.org/anais_bashirian',
            'last-time': '1996-12-19T16:39:57-08:00', 'name': 'events', 'total-messages': 11865925672736946994}
    ...
    Attributes:
        ...
        bytes_ (Union[Unset, int]): Number of bytes in the queue Example: 3223454809864452206.
        consumer_count (Union[Unset, int]): Number of consumers Example: 3513071942167408692.
        description (Union[Unset, str]): Description of the queue. Example: Events for the event service.
        first_id (Union[Unset, str]): First identifier in the queue Example: http://legros.com/jean_hoeger.
        first_time (Union[Unset, datetime.datetime]): Timestamp of the first message in the queue Example:
            1996-12-19T16:39:57-08:00.
        last_id (Union[Unset, str]): Last identifier in the queue Example: http://bode.info/furman.
        last_time (Union[Unset, datetime.datetime]): Timestamp of the last message in the queue Example:
            1996-12-19T16:39:57-08:00.
        total_messages (Union[Unset, int]): Number of messages sent to the queue Example: 2003824122055284682.
    """
